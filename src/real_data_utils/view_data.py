...
def plot_data_set(data, labels):
    ...
    while True:
        ...
        fig.text(
            0.3,
            0.95,
            f"[Paused: {is_paused}]; double_click: pause/unpause; left_click: slide_left; right_click: slide_right",
            size=10,
            rotation=0,
            ha="center",
            va="center",
        ...
        for col in range(C):
            ...
            for ind in range(R):
                ...
                ax.set_title(
                    f"index: [{index_row}] labels: {labels[index_row, :].astype(int)}"
                )
...
if __name__ == "__main__":
    if len(sys.argv) > 2:
        ...
        print(f"Example: {sys.argv[0]} ../../data/all.1000_16.npy 16")
